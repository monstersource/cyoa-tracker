...
},{"./debounce":"../node_modules/lodash/debounce.js","./isObject":"../node_modules/lodash/isObject.js"}],"../node_modules/codemirror/lib/codemirror.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{}],"../node_modules/codemirror/addon/mode/simple.js":[function(require,module,exports) {
var define;
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
},{"../../lib/codemirror":"../node_modules/codemirror/lib/codemirror.js"}],"../node_modules/codemirror/addon/scroll/simplescrollbars.js":[function(require,module,exports) {
var define;
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
},{"../../lib/codemirror":"../node_modules/codemirror/lib/codemirror.js"}],"ts/main.ts":[function(require,module,exports) {
"use strict"; //  main  //////////////////////////////////////////////////////////////
...
exports.__esModule = true; // modules
...
var displayResults = function displayResults(results, total) {
...
var mathsValue = function mathsValue(current, operator, number) {
  switch (operator) {
    case "+":
      current += number;
      break;
...
var grepEditor = function grepEditor() {
  console.log("grepping..."); // add a generic header to the document to make sure there's
  // actually something there.
  // useful since line numbers start at 1 and arrays start at 0.

  var editorValue = "### start\n" + editor.getValue(); // split editor content
  ...
  for (var i = 0, max = sections.length; i < max; i++) {
    ...
    var result = {
      start: sections[i][0][0],
      title: sections[i][0][2][1],
      value: 0
    }; // sum up each line's value, starting *after* the header

    for (var j = 1, max_1 = sections[i].length; j < max_1; j++) {
      var line = sections[i][j];
      var operator = line[2][1]; // replace commas with periods for international users

      var number_1 = parseFloat(line[2][2].replace(/,/g, ".")); // apply this line's value to the group's total

      result.value = mathsValue(result.value, operator, number_1);
    } // push the group's result to the main array


    results.push(result); // apply the group's total to the grand total
